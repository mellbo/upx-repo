...
function inject_function_settings() {
  ...
  /*-----------------------------------------------------------------------------------*/  
   ...
   /*-----------------------------------------------------------------------------------*/
    window.confTmPckrOKBtn = function (okFunction, paramIds) {
        /*Use:
        ...
        okBtn.onclick = function() {
            if (paramIds && paramIds.length > 0) {
                ...
                for (let i = 0; i < paramIds.length; i++) {
                    params.push(document.getElementById(paramIds[i]).value);
                }
  ...
  /*-----------------------------------------------------------------------------------*/
    window.sendQuickAct = function (varParDataJS) {
      if (!varParDataJS || Object.keys(varParDataJS).length === 0) {
        console.log("sendQuickAct:", "err: no object to send!");
        return;
      }
            ...
            switch (eventCode) {
              ...
              default:
                ...
                case: 1:🌡️Thermostat Outside, 5:🕒USR Change SmartWelcome, 11:💡Allow LightOff,
                      ...
                      22:❌️🧑️‍💻RST current Mohth, 23:❌🧑️‍💻RST ALL Mohth
